    ...
    <main className="min-h-screen pt-24 pb-28 px-6 md:px-16 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-start gap-6 sm:flex-row">
            ...
            <div className="flex flex-col gap-2 sm:hidden">
              {snsLinks.map((sns) => (
                <a
                  ...
                  className="inline-flex items-center justify-center h-10 w-10 rounded bg-gray-50 text-gray-500 transition-colors hover:bg-gray-100"
        ...
        <div className="space-y-4">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 md:text-3xl">{person.name}</h1>
