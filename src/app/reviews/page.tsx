...
const REVIEWED_ITEMS: { id: number; type: "movie" | "tv" }[] = [
  ...
  { id: 19995, type: "movie" },
  { id: 629, type: "movie" },
  { id: 581734, type: "movie" },
  { id: 475557, type: "movie" },
  { id: 671, type: "movie" },
  { id: 8392, type: "movie" },
];
...
export default async function ReviewsPage() {
  ...
  return (
    <main className="min-h-screen bg-white pt-14 md:pt-24 pb-28 px-6 md:px-16">
        ...
        {movies.map((movie, i) => {
          ...
          return (
            <Link
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-[4px] transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-black/15">
                {movie.poster_path ? (
                  <img
