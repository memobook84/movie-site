...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-gray-200/60 px-6 py-10 text-center text-xs text-gray-400 md:px-16 md:max-w-[1280px] md:mx-auto">
      {/* TMDbロゴ（一時非表示: h-3 opacity-40 grayscale）
      ...
      */}
      <p className="mt-1">© 2026 CINEMA. Powered by TMDb.</p>
