...
export default function PersonCard({ person }: PersonCardProps) {
  return (
    <Link href={`/person/${person.id}`} className="group flex-shrink-0">
      <div className="w-[129px] overflow-hidden rounded-[3px] bg-white shadow-md transition-all duration-300 group-hover:shadow-lg md:w-[178px]">
        <div className="relative h-[165px] overflow-hidden md:h-[240px]">
          {person.profile_path ? (
            <img
        ...
        <div className="px-2 py-2">
          <p className="truncate text-[9px] font-medium text-gray-900 md:text-xs">
            {person.name}
          </p>
