  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center h-[50px] w-[50px] rounded-[2px] border-none cursor-pointer transition-colors duration-300 bg-[#313638] hover:bg-[#cd242b]"
        aria-label="ピクチャー"
      >
